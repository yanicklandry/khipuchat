...
- [ ] 1. Foundation — verify script entry and create test skeleton
...
- [ ] 2. Core — transport client and data mappers
- [ ] 2.1 (P) Implement Slack transport client
...
- [ ] 2.2 (P) Implement chat and message mappers
...
- [ ] 3. Sync runners, adapter factory, and entry point
- [ ] 3.1 Implement backfill runner
...
- [ ] 3.2 Implement incremental runner
...
- [ ] 3.3 Implement adapter factory and main entry
...
- [ ] 4. Tests — unit and integration coverage
- [ ] 4.1 Unit tests for mappers and client error handling
...
- [ ] 4.2 Integration tests for runners and token guard
