...
- [x] 1. Platform registration and project configuration
- [x] 1.1 Register 'wechat' in the Platform union and project scripts
...
- [x] 2. Test file scaffolding and in-memory DB utilities
- [x] 2.1 Create test file stubs with shared in-memory helpers
...
- [x] 3. Container validation and DB discovery
- [x] 3.1 Implement container path resolution and validation
...
- [x] 3.2 Implement user directory discovery and message DB enumeration
...
- [x] 4. Key resolver and DB opener
- [x] 4.1 Implement key map loading and per-DB hex-key resolution
...
- [x] 4.2 Implement the read-only DB opener with graceful error degradation
...
- [x] 5. Contact resolver
- [x] 5.1 Implement buildWechatContactMap supporting both V3 and V4 contact schemas
...
- [x] 6. (P) Key-extraction setup script
- [x] 6.1 Write the opt-in local key-extraction helper
...
- [x] 7. Schema detection and V4 lookup maps
- [x] 7.1 Implement schema detection for V3 and V4 WeChat DB layouts
...
- [x] 7.2 Implement V4 identity lookup maps from Name2Id
...
- [x] 8. Row mappers
- [x] 8.1 Implement chat mapper and helper utilities
...
- [x] 8.2 Implement message mapper with full V3/V4 and sender_name support
...
- [x] 9. Sync core: backfill and incremental implementations
- [x] 9.1 Implement runBackfillImpl iterating all discovered DBs and tables
...
- [x] 9.2 Implement runIncrementalImpl with per-chat timestamp filtering
...
- [x] 10. WeChat adapter and entry point
- [x] 10.1 Implement wechatAdapter and main() wired through runPlatformSync
...
- [x] 11. Unit tests for pure functions
- [x] 11.1 Write unit tests for chat and message mappers
...
- [x] 11.2 Write unit tests for schema detection and contact resolver
...
- [x] 12. Integration tests and error-path coverage
- [x] 12.1 Write integration tests for the sync core
...
- [x] 12.2 Write error-path and image-message tests
