...
- [x] 1. Foundation — types, dependency, script, test scaffold
- [x] 1.1 Register 'email' platform and add imapflow
...
- [x] 1.2 Create test file with mock IMAP client
...
- [x] 2. Core — IMAP client and mappers (parallel)
- [x] 2.1 (P) Implement the imapflow-based email client
...
- [x] 2.2 (P) Implement thread resolver and message mapper
...
- [x] 3. Backfill runner and adapter
- [x] 3.1 Implement runBackfillImpl
...
- [x] 3.2 Implement adapter and main entry point
...
- [x] 4. Tests
- [x] 4.1 Unit and integration tests
