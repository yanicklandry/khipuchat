...
- [x] 1. Foundation — dependencies, script, test scaffold
- [x] 1.1 Add whatsapp-web.js dependencies and npm script
...
- [x] 2. Core — client wrapper and mappers (parallel)
- [x] 2.1 (P) Implement the whatsapp-web.js client wrapper
...
- [x] 3.1 Implement runBackfillImpl and adapter
