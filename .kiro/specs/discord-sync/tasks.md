...
- [x] 1. Foundation: project scaffold and test infrastructure
- [x] 1.1 Add sync script and create platform directory structure
...
- [x] 2. Core: Discord REST client and row mappers
...
- [x] 2.2 (P) Implement row mappers, hash helper, and snowflake converter
...
- [x] 3. Sync runners: backfill and incremental
...
- [x] 4. Integration: adapter factory and CLI entry point
- [x] 4.1 Wire the adapter factory, CLI entry point, and multi-account registration
...
- [x] 5.2 Integration tests for runners and adapter
