...
- [ ] 1.1 (P) Add `type` field to keyword search read model
...
- [ ] 1.2 (P) Add `type` field to semantic search read model
...
- [ ] 2.1 (P) Redefine result type and expand DB query
...
- [ ] 2.2 Add type validation and file-unavailable degradation to handler
...
- [ ] 3.1 Add get_image dispatch and usage to CLI
...
- [ ] 4. Test coverage
- [ ] 4.1 Unit tests for handler contract and search models
...
- [ ] 4.2 Integration and regression tests
...
- [ ]* 4.3 Regression smoke-test for existing infrastructure requirements
