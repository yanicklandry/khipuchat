...
- [x] 1.3 (P) Redefine image retrieval result type and expand handler SELECT
...
- [ ] 2. Handler validation and CLI surface
- [x] 2.1 Add type validation and file-unavailable degradation to handler
...
- [x] 2.2 Add get_image dispatch and usage to CLI
...
- [ ] 3. Test coverage
- [x] 3.1 Unit tests for handler contract and search models
...
- [x] 3.2 Integration and regression tests
...
- [x]* 3.3 Regression smoke-test for existing infrastructure requirements
