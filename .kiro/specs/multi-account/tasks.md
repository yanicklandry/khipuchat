...
- [x] 1.1 Extract migration logic and add account dimension to chats
...
- [x] 1.2 Rebuild sync_state to composite (platform, account) primary key
...
- [x] 2. (P) Account configuration registry
- [x] 2.1 Load accounts and enumerate by platform
...
- [x] 2.2 Validate registry entries and resolve secrets
...
- [x] 3. Account-aware database persistence layer
- [x] 3.1 Update Chat type and upsertChat to return surrogate id
...
- [x] 3.2 Update sync_state accessors to (platform, account) key
...
- [x] 3.3 Add optional account filter to searchMessages
...
- [x] 4. Extracted account-aware query handlers
- [x] 4.1 Extract query handlers from mcp.ts into query-handlers.ts
...
- [x] 4.2 Thread account filter through all query handlers
...
- [x] 4.3 Add listArchiveAccounts helper to query layer
...
- [x] 5. (P) Vec-db account filter and result field
...
- [x] 6. Platform adapter factories and per-account sync runner
- [x] 6.1 Update PlatformAdapter interface and add AdapterFactory type
...
- [x] 6.2 Update sync-runner to iterate configured accounts with error isolation
...
- [x] 6.3 (P) Update platform adapters to factory pattern
...
- [x] 7. MCP surface: thin wiring and account parameter in tool schemas
  - _Depends: 4.1, 4.2_
- [x] 7.1 Import from query-handlers and add account to tool schemas
...
- [x] 8. (P) CLI surface: --account filter and output labeling
  - _Depends: 4.2, 4.3_
- [x] 8.1 Add --account flag and conditional account column to CLI output
...
- [x] 9. (P) Web surface: account filter and conditional label
  - _Depends: 4.2, 4.3_
- [x] 9.1 Add ?account= query parameter to web API routes
...
- [x] 9.2 Add account filter control and conditional label to web UI
...
- [x] 10. Unit tests
- [x] 10.1 (P) account-registry unit tests
...
- [x] 10.2 (P) Database migration and persistence unit tests
...
- [x] 11. Integration and E2E tests
- [x] 11.1 Sync-runner integration tests
...
- [x] 11.2 (P) Adapter factory and credential isolation tests
